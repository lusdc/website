...
function TeamMember({name, title, image, github, linkedin}) {
  return (
    <div className='flex flex-col items-center p-4 mt-3 text-center bg-gray-200 shadow-sm rounded-xl hover:shadow-xl dark:bg-gray-700'> 
        <img src={image} alt={name + " photo"} className='w-24 h-24 rounded-full' />
        <h2 className='text-lg font-bold dark:text-gray-100'>{name}</h2>
        <p className='text-gray-700 dark:text-gray-400'>{title}</p>
        <div className='flex justify-center space-x-2'>
          {linkedin
          &&
          <a href={linkedin} target="_blank" rel="noopener noreferrer" className='mt-2 hover:scale-110'>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-linkedin fill-black dark:fill-white" viewBox="0 0 16 16">
          ...
          {github 
          && 
          <a href={github} target="_blank" rel="noopener noreferrer" className="mt-2 hover:scale-110">
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-linkedin fill-black dark:fill-white" viewBox="0 0 16 16">
...
function About() {
  return (
    <>
        ...
        <p className='text-gray-700 dark:text-gray-400'>The Software Development Club is a group of students and faculty at Liberty University who are passionate about software development. We meet weekly to learn new technologies, work on projects, and network with industry professionals.</p>
