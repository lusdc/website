...
function Home() {
  return (
    <>
      <div className='flex items-center justify-between w-full my-[4rem] space-x-4'>
        <div className=''>
          <h2 className='text-4xl font-bold text-custom-light-orange xl:text-5xl dark:text-custom-light-orange'>Software Development Club</h2>
          <h3 className='text-3xl font-thin text-gray-700 dark:text-gray-400 xl:text-4xl'>at Liberty University</h3>
          <div className='flex mt-5 space-x-4'>
            ...
            <a href='https://www.linkedin.com/company/lusdc/' target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-linkedin fill-black lg:h-8 lg:w-8 dark:fill-white hover:scale-110" viewBox="0 0 16 16">
       ...
       <div className='mb-[4rem] items-stretch md:justify-between md:flex md:space-x-6 space-y-4 md:space-y-0'>
        <CardWithGraphic
       ...
       <p>We meet every Monday at 6 PM in SoBusi 2810. All are welcome!</p>
       
       <h4 className='my-5 text-lg font-bold'>Event Calendar</h4>
        <iframe
          className="mb-4 rounded-lg shadow-lg hover:shadow-xl"
