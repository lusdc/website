        ...
        <div className=''>
          ...
          <div className='flex mt-2 space-x-4'>
            ...
            <a href='https://www.linkedin.com/company/lusdc/' target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-linkedin fill-black lg:h-8 lg:w-8 dark:fill-white hover:scale-110" viewBox="0 0 16 16">
